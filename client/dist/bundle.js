...
/***/ function(module, exports, __webpack_require__) {
	...
	var RxWebsocketSubject = (function (_super) {
	    ...
	    function RxWebsocketSubject(url, reconnectInterval, reconnectAttempts, resultSelector, serializer) {
	        var _this = this;
	        ...
	        this.defaultResultSelector = function (e) {
	            return JSON.parse(e.data);
	        };
	        this.defaultSerializer = function (data) {
	            return JSON.stringify(data);
	        };
	        this.connectionStatus = new rxjs_1.Observable(function (observer) {
	        ...
	        this.connect();
	        this.connectionStatus.subscribe(function (isConnected) {
	...
	var getWsUrl = function (s) {
	    var l = window.location;
	    return ((l.protocol === "https:") ? "wss://" : "ws://") + l.host + l.pathname + s;
	};
	var randomId = Math.random().toString(36).substr(2, 5); // random id
	var channelService = new RxWebsocketSubject(getWsUrl('ws') + ("?uid=" + randomId));
	var textareaLog = document.getElementById('connectionLog');
	var sendMsgBtn = document.getElementById('sendMessageButton');
	var clickCount = 0;
	var addLogMessage = function (msg) {
	    textareaLog.value += msg + "\n";
	    textareaLog.scrollTop = textareaLog.scrollHeight;
	};
	rxjs_1.Observable.fromEvent(sendMsgBtn, 'click').subscribe(function (e) {
	    clickCount += 1;
	    channelService.send(String(clickCount));
	});
	channelService.subscribe(function (e) {
	...
	channelService.connectionStatus.subscribe(function (isConnected) {
	    textareaLog.disabled = sendMsgBtn.disabled = !isConnected;
	    var msg = isConnected ? 'Server connected' : 'Server disconnected';
	    addLogMessage(msg);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Observable_1 = __webpack_require__(3);
	var distinctKey_1 = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(284).clearImmediate, __webpack_require__(284).setImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(284).setImmediate, __webpack_require__(284).clearImmediate))
